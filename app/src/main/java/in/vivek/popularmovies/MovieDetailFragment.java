...
import in.vivek.popularmovies.adapter.ReviewAdapter;
import in.vivek.popularmovies.adapter.VideoAdapter;
import in.vivek.popularmovies.api.Movie;
import in.vivek.popularmovies.api.MovieDbOrgApiService;
import in.vivek.popularmovies.api.Review;
import in.vivek.popularmovies.api.ReviewServiceResponse;
import in.vivek.popularmovies.api.Video;
import in.vivek.popularmovies.api.VideoServiceResponse;
import in.vivek.popularmovies.data.MovieProvider;
import in.vivek.popularmovies.data.MovieTableMeta;
import in.vivek.popularmovies.data.ReviewTableMeta;
import in.vivek.popularmovies.data.VideoTableMeta;
...
public class MovieDetailFragment extends Fragment {
    ...
    private void changeFavoriteButtonColor(){
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP){
            ...
            if(isFavorite){
                favoriteStar.setBackground(ContextCompat.getDrawable(mContext,android.R.drawable.star_big_on));
                favoriteText.setText(mContext.getResources().getText(R.string.remove_from_favorites));
            }else{
                favoriteStar.setBackground(ContextCompat.getDrawable(mContext,android.R.drawable.star_big_off));
                favoriteText.setText(mContext.getResources().getText(R.string.add_to_favorites));
            }
        }
